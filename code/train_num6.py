...
def train():
  ...
  for sub in train_dataset_total.subject_type.unique():
    for ob in train_dataset_total.object_type.unique():
      ...
      train_dataset_total = train_dataset_total.drop(train_dataset.index)
      dev_dataset_total = dev_dataset_total.drop(dev_dataset.index)
      ...
      training_args = TrainingArguments(
        output_dir=f'./code/results/{wandb_name}_{ob}_{sub}',          # output directory
      ...
      # train model
      trainer.train()
      model.save_pretrained(f'./best_model/{wandb_name}_{ob}_{sub}')
