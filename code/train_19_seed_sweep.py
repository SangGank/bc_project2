...
os.environ['WANDB_PROJECT'] = 'pj2_train_loss'
...
def train():
  ...
  # load model and tokenizer
    ...
    # load dataset
    train_dataset = load_data("./data/dataset/train/train_type.csv")[:1600]
    ...
    # tokenizing dataset
    tokenized_train = tokenized_dataset19(train_dataset, tokenizer)
    tokenized_dev = tokenized_dataset19(dev_dataset, tokenizer)
...
def main():
  ...
  sweep_id = wandb.sweep(sweep=sweep_config, project="pj2_train_loss")
